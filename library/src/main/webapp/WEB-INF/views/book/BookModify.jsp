<%--
  Class Name : BookModify.jsp
  Description : Book Modify JSP
  Modification Information
 
  수정일         수정자        수정내용
  -------      --------    ---------------------------
  2019.01.26   yeoni94     최초 생성
--%>
...
function fn_modify(){
	...
	document.BookModifyForm.action = "<c:url value='/book/BookModify.do'/>";
	document.BookModifyForm.submit();
}
...
function fn_delete(){
	document.BookModifyForm.action = "<c:url value='/book/BookDelete.do'/>";
	document.BookModifyForm.submit();
}
      ...
      <div class="col-lg-12"> 
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">
            <strong><a href='#'>도서 수정</a></strong>
          </li>
        </ol>
      </div>
      <br/>
      <form:form id="BookModifyForm" name="BookModifyForm" method="post" enctype="Multipart/form-data">  
	      <div class="row">
	          ...
	          <div class="panel panel-default">
	            ...
	            <div class="panel-body">
	                 <div class="row">
	                   ...
	                   <div class="col-md-10"><input class="form-control" type="file" id="file" name="file"/></div>
	                 </div>   
	                 <div class="row">
	                 ...
	                 <div class="row">
	                   ...
	                   <div class="col-md-10">
	                     <div class="input-group date">
                           <input type="text" class="form-control" id="publish_date" name="publish_date" value="<fmt:formatDate value='${bookInfoVO.publish_date}'  pattern='yyyy/MM/dd'/>" readonly /> 
                     ...
                     <input type="hidden" id="bseq" name="bseq" value="${bookInfoVO.bseq}"/>
	            </div>
	          </div> 
	        </div>
	      </div>
	      <div class="row">
	        <div class="col-md-8 col-md-offset-2">
	          <div class="panel panel-default">
	            ...
	            <div class="panel-body">
	                <div class="row">
	                  <div class="col-md-2"><h5>등록 번호 </h5></div>
	                  <div class="col-md-10"><input class="form-control" type="text" id="bnum" name="bnum" value="${bookInfoVO.bnum}" readOnly/></div>
	                </div>
	                <div class="row">
	      ...
	      <div class="row">
	        <div class="col-md-8 col-md-offset-2">
	          <div class="text-right">
	           <p>
				  <button type="button" class="btn btn-success" onclick="javascript:fn_modify(); return false;">수정</button>
				  <button type="button" class="btn btn-danger" onclick="javascript:fn_delete(); return false;">삭제</button>								
    		   </p>
	          </div>
	        </div>
	      </div>
